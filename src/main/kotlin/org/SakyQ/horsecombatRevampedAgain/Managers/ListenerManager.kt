...
import org.SakyQ.horsecombatRevampedAgain.listeners.HorseEggspawner
...
class ListenerManager(private val plugin: HorsecombatRevampedAgain) {
    ...
    private val horseEggspawner: HorseEggspawner = HorseEggspawner(plugin)
    ...
    fun registerAllListeners() {
        plugin.server.pluginManager.apply {
            ...
            registerEvents(horseEggspawner, plugin)
        }
    }
    ...
    fun getHorseEggspawner(): HorseEggspawner = horseEggspawner
}